...
impl TryFrom<proto::cosmwasm::wasm::v1::QueryCodeResponse> for QueryCodeResponse {
    ...
    fn try_from(proto: proto::cosmwasm::wasm::v1::QueryCodeResponse) -> Result<QueryCodeResponse, ErrorReport> {
        Ok(QueryCodeResponse { code_info: proto.code_info.map(TryFrom::try_from).transpose()?, data: proto.data })
    }
}
