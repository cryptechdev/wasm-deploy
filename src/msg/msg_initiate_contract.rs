...
impl TryFrom<proto::cosmwasm::wasm::v1::MsgInstantiateContract> for MsgInstantiateContract {
    ...
    fn try_from(
    ...
    ) -> Result<MsgInstantiateContract, ErrorReport> {
        Ok(MsgInstantiateContract {
            ...
            msg:     proto.msg,
            funds:   proto.funds.into_iter().map(TryFrom::try_from).collect::<Result<_, _>>()?,
        })
    }
}
...
impl TryFrom<proto::cosmwasm::wasm::v1::MsgInstantiateContractResponse> for MsgInstantiateContractResponse {
    type Error = ErrorReport;

    fn try_from(
        proto: proto::cosmwasm::wasm::v1::MsgInstantiateContractResponse,
    ) -> Result<MsgInstantiateContractResponse, ErrorReport> {
        Ok(MsgInstantiateContractResponse { address: proto.address.parse()?, data: proto.data })
    }
}

impl From<MsgInstantiateContractResponse> for proto::cosmwasm::wasm::v1::MsgInstantiateContractResponse {
    fn from(msg: MsgInstantiateContractResponse) -> proto::cosmwasm::wasm::v1::MsgInstantiateContractResponse {
